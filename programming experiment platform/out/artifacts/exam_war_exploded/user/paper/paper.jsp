	...
	<nav class="navbar navbar-default" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				<li><a href="<%=basePath%>user?cmd=online">在线编程</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#Radio">题目详情：</a>
						</h4>
					</div>
							...
							<div class="panel-body">
								<ol>
									<c:forEach items="${subjects}" var="item" varStatus="status">
										<div class="subject" data-answer="false" data-sid="${item.sid}" data-key="${item.skey}" data-state="0"
											data-skey>
											<a>题目描述：</a>
											<p>${item.scontent}</p>
											<a>输入范例1：</a>
