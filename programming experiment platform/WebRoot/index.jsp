...
<body style="background-color:#f2f9fd;">
    <div class="header bg-main">
        <div class="logo margin-big-left fadein-top">
            <h1><img src="css/images/x.jpg" class="radius-circle rotate-hover" height="50" alt="" /><a style="color: #2D93CA">后台管理中心</a></h1>
        </div>
        <div class="head-l">
    ...
    <div class="leftnav">
        <div class="leftnav-title"><strong><span class="icon-list" style="color: black"></span><a style="color: black">菜单列表</a></strong></div>
