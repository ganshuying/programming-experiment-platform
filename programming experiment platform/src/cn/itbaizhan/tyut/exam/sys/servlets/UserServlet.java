...
public class UserServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		} else if(cmd.equals("online")) {//新加
			onlinepro(request, response);
	 ...
	 * @param response
	 */
	private void onlinepro(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			request.getRequestDispatcher("/user/online.jsp").forward(request, response);
